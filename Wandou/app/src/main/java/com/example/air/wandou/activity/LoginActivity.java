...
import com.example.air.wandou.web.WebService;
...
public class LoginActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TabViewChild tabViewChild01 = new TabViewChild(0, 0, "登录",null);
        TabViewChild tabViewChild02 = new TabViewChild(0,0, "注册",null);
